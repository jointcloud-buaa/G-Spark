...
object GlobalDriverWrapper {
  def main(args: Array[String]) {
    args.toList match {
       ...
       */
      case siteMasterUrl :: userJar :: mainClass :: extraArgs =>
        val conf = new SparkConf()
        val rpcEnv = RpcEnv.create("GlobalDriver",
        ...
        val loader =
          if (sys.props.getOrElse("spark.globalDriver.userClassPathFirst", "false").toBoolean) {
