 ...
 */
private[deploy] class FileSystemRecoveryModeFactory(conf: SparkConf, serializer: Serializer)
...
private[deploy] class ZooKeeperRecoveryModeFactory(conf: SparkConf, serializer: Serializer)
