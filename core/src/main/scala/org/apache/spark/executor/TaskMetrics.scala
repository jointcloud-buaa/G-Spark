...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleRead.REMOTE_CLUSTER_BLOCKS_FETCHED -> shuffleReadMetrics._remoteClusterBlocksFetched,
    shuffleRead.LOCAL_BLOCKS_FETCHED -> shuffleReadMetrics._localBlocksFetched,
    shuffleRead.REMOTE_BYTES_READ -> shuffleReadMetrics._remoteBytesRead,
    shuffleRead.REMOTE_CLUSTER_BYTES_READ -> shuffleReadMetrics._remoteClusterBytesRead,
    ...
    shuffleRead.LOOP_WAIT_BLOCK_TIME -> shuffleReadMetrics._loopWaitBlockTime,
