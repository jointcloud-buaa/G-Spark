 ...
 * is known.
 */
private [spark] object ExecutorLossReasonPending extends ExecutorLossReason("Pending loss reason.")
 ...
 */
private[spark]
case class ExecutorSlaveLost(_message: String = "Slave lost", workerLost: Boolean = false)
